...
class login(Frame):
    ...
    def createwidget(self):
        ...
        self.imgHi=ImageTk.PhotoImage(Image.open(r"icons\chat.ico"))
        ...
        self.imgfb = ImageTk.PhotoImage(Image.open(r"icons\facebook.ico"))
    ...
    def funcBtnLogin(self):
        ...
        if(check.check(self.comboBox.get(),self.userEntryvar.get(),self.userpwdvar.get())==True):
            if(self.comboBox.get()=='User'):
                ...
                self.top.wm_iconbitmap(r"icons\Icon2.ico")
                ...
                self.imgUpload = ImageTk.PhotoImage(Image.open(r"icons\bt_up.ico"))
                ...
                self.imgNearby = ImageTk.PhotoImage(Image.open(r"icons\places.ico"))
                ...
                self.imgPlay = ImageTk.PhotoImage(Image.open(r"icons\play.ico"))
                ...
                self.imgUpdate = ImageTk.PhotoImage(Image.open(r"icons\update.ico"))
    ...
    def funcFbBtn(self):
        ...
        driver = webdriver.Chrome(r"C:\Users\01rag\AppData\Local\Programs\Python\Python36-32\Scripts\chromedriver.exe") #chromedriver for chrome browsing
...
window.wm_iconbitmap(r"icons\Icon2.ico")
lf=login(window)
window.mainloop()
